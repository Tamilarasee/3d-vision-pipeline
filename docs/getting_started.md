...
1. Navigate to the [repository](https://github.com/tamilarasee/3d-vision-pipeline).
...
1. Update the following files:
   ...
   - `README.md`:
      ...
      ```markdown
      https://tamilarasee.github.io/3d-vision-pipeline/
      ```
   ...
   - `landing.py`:
      ...
      ``` bash
      tamilarasee/3d-vision-pipeline
      ```
